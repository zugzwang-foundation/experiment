...
> **Status:** 1.0.21 · v1.0 locked at PRECURSOR.4 (2026-06-03, fresh-session writer/reviewer review per CLAUDE.md) · §0–§23 + Appendices A–B complete · backend-complete as of the BC (Backend-Consolidation) sweep (2026-07-01): ENGINE .0–.16, DEBATE incl. .4 render, EXPORT.1, MEDIA.1 all landed on `main` · migration head 0024, ADRs 0003–0034 (32) folded (current through BOOKMARK-ADD-WIRE, 2026-07-30; ADR-0033 is index-row only — its substance is folded into neither spec) · ADR-0009 superseded-by-0017 · **reply-as-bet model** (every comment rides a bet; friendly-fire + `friendly_fire_events` + `stake_at_post_time` removed entirely; Support/Counter are read-time aggregates over reply-bets) consistent with SPEC.1 (1.0.14) · K_eff dashboard struck per PRECURSOR.2-B D4 (no live in-product surface; K_eff(t) derived post-hoc from the 2026-11-06 public dataset per SPEC.1 G3 + §12.2)
