...
> **Status:** v0.3.1-draft · last absorption 2026-05-15 · §0–§23 + Appendices A–B all drafted at v0.3-draft body level · K_eff dashboard struck per PRECURSOR.2-B D4 (no live in-product surface; K_eff(t) derived post-hoc from 2026-11-06 public dataset per SPEC.1 G3 + §12.2)
