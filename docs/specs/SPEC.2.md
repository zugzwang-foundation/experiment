...
| Concern | Source-of-truth file |
|---|---|
| Per-ADR substance | `docs/adr/<NNNN>-<slug>.md` (25 ADRs — 24 ADR files + ADR-0012 in-flight; 22 accepted + 2 superseded + 1 in-flight; files committed at SYNC.BACKFILL + ADR-0026 + ADR-0027) |
