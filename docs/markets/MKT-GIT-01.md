...
**MKT-GIT-01** · `/m/github-zugzwang-repo-stars` · **v2.2** · 2026-09-08  
**Subject** GitHub star count for the Zugzwang experiment repository · GitHub  
**Supersedes** `MKT-GIT-01_market-spec_v2_1.md (v2.1, 2026-09-08)`
...
| Resolver | GitHub, Inc. — the publisher of the number, not a decision-maker |
| Resolution | GitHub |
| Flavour | Callout |

Display block: **RESOLUTION** GitHub · **RESOLVER** Zugzwang / repo → `https://github.com/zugzwang-foundation/experiment` · **CLOSES ON** 5 Nov 2026 / 23:45Z · **FLAVOUR** Callout
