...
- *Slots:* side badge · position marker · **friendly-fire tag** (only when flagged; the same outlined marker primitive as Flipped / Exited, text `Friendly fire`) · reply stake · argument text.
