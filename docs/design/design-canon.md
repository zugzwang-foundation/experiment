...
5. **"Đ BET" wordmark** end-to-end (entry button `Đ BET` → submit `PLACE Đ BET`; reads as DEBATE). *(MIRROR-1, 2026-09-23: the post composer no longer shows the header `Place your Đ BET` — it remains the composer's accessible name. Reply composers keep `Support/Counter <author>'s argument`.)*
...
**Composer (all bet composers):** layout and copy live in `docs/design/composer-mirror.md` (MIRROR-1, founder-ratified 2026-09-23); the string list that stood here is superseded.
