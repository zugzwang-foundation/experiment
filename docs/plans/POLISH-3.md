...
## §19 · Gate C read-1 rulings — founder, 2026-08-13

**APPEND-ONLY. §1–§18 are unedited.** Seven rulings from Gate C read 1, each recorded with its ground so a later reader finds a definition rather than a citation. *(The `PF-n` series was cited in three PR-1 commit bodies before it was defined anywhere; that gap is what this section closes — a citation without a definition is the L-space collision `CLAUDE.md` §8 was minted to stop.)*
