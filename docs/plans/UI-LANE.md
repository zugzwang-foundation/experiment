...
| A4 | Discovery | `/` route (displaces placeholder) · list-open-markets read model · hero/top-posts selection · card DTO · ranking modes | Standard; ultracode allowed on reversible parts | SPEC.1 discovery · ADR-0017 · RANKING.md · canon §8 row 1 |
