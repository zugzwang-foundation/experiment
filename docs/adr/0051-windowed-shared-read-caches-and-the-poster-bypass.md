...
| **Superseded-by** | — |
| **Amends** | — |
| **Patch records** | P1 (CACHE-COALESCE-1, 2026-09-22) — the window was written for one cache; the fleet has one per instance · P2 (CACHE-COALESCE-2, 2026-09-23) — the same single-flight behind the two Discovery blocks |
