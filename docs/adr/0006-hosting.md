...
| ADR-0007 (gating) | Observability vendor configuration | This ADR ratifies the hosting platform on which Sentry / PostHog run. ADR-0007 owns the vendor-configuration substance. Vercel deploy hooks → Sentry release tagging is a SCAFFOLD.5 wiring, no §18 substance change here. |
