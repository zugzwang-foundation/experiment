...
*Three rows minted before 2026-08-10 (PD-2-02, PD-2-06, CC-4) carry dual class values predating POLISH-0 §4.1. Grandfathered — not split, because splitting a closed row is churn. §4.1 binds every row minted after 2026-08-10.*
