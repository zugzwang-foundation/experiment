...
│   │                               #   read EIGHT until MOBILE-2d added `scroll-lock.ts`, the
│   │                               #   subtree's first non-component module. It is, and
...
│   │                               #   PhoneSheet), TWO SERVER (PhoneDetails ·
│   │                               #   PhoneResolverRows) and ONE module (scroll-lock.ts,
│   │                               #   MOBILE-2d — the shared scroll lock, imported by
│   │                               #   PhoneSheet AND by chart/MarketPriceChartOverlay) — the details sheet's body is an
