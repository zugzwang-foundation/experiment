...
vi.mock("next/navigation", () => ({
	// REPLY-IMAGE-EXPORT — the reply card now carries `DownloadPostImage`, which
	// reads the market slug from the route; a mock without `useParams` throws at
	// the first reply card render.
